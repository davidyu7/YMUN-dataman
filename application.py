...
def s2():
    if request.method =="GET":
        absences = db.execute("SELECT Attendance.name AS delegate_name, Attendance.school, Delegates.committee_assigned, Delegates.position_name, Advisors.name AS advisor_name, Advisors.us_phone_number FROM Attendance JOIN Advisors ON Attendance.school = Advisors.school JOIN Delegates ON Attendance.name = Delegates.name AND Attendance.school = Delegates.school WHERE Advisors.point_of_contact = '1' AND s2 ='0.0' ORDER BY Attendance.school;")
...
def s3():
    if request.method =="GET":
        absences = db.execute("SELECT Attendance.name AS delegate_name, Attendance.school, Delegates.committee_assigned, Delegates.position_name, Advisors.name AS advisor_name, Advisors.us_phone_number FROM Attendance JOIN Advisors ON Attendance.school = Advisors.school JOIN Delegates ON Attendance.name = Delegates.name AND Attendance.school = Delegates.school WHERE Advisors.point_of_contact = '1' AND s3 ='0.0' AND s2 != '0.0' ORDER BY Attendance.school;")
...
def s4():
    if request.method =="GET":
        absences = db.execute("SELECT Attendance.name AS delegate_name, Attendance.school, Delegates.committee_assigned, Delegates.position_name, Advisors.name AS advisor_name, Advisors.us_phone_number FROM Attendance JOIN Advisors ON Attendance.school = Advisors.school JOIN Delegates ON Attendance.name = Delegates.name AND Attendance.school = Delegates.school WHERE Advisors.point_of_contact = '1' AND s4 ='0.0' ORDER BY Attendance.school;")
...
def s5():
    if request.method =="GET":
        absences = db.execute("SELECT Attendance.name AS delegate_name, Attendance.school, Delegates.committee_assigned, Delegates.position_name, Advisors.name AS advisor_name, Advisors.us_phone_number FROM Attendance JOIN Advisors ON Attendance.school = Advisors.school JOIN Delegates ON Attendance.name = Delegates.name AND Attendance.school = Delegates.school WHERE Advisors.point_of_contact = '1' AND s5 ='0.0' AND s4 != '0.0' ORDER BY Attendance.school;")
...
def s6():
    if request.method =="GET":
        absences = db.execute("SELECT Attendance.name AS delegate_name, Attendance.school, Delegates.committee_assigned, Delegates.position_name, Advisors.name AS advisor_name, Advisors.us_phone_number FROM Attendance JOIN Advisors ON Attendance.school = Advisors.school JOIN Delegates ON Attendance.name = Delegates.name AND Attendance.school = Delegates.school WHERE Advisors.point_of_contact = '1' AND s6 ='0.0' AND s5 != '0.0' ORDER BY Attendance.school;")
